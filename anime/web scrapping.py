""" Esse é um projeto pessoal que compõe meu portifólio, o projeto será divido em etapas
    A primeira etapa consiste na busca dos dados na internet utilizando algumas bibliotecas do python
    A escolha do site foi por facilidade, busquei o site que continha mais informações para que eu pudesse utilizar nas
    Etapas posteriores."""
