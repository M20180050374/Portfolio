...
após isso é feito um dashboard utilizando Power BI e Python (talvez) e, por fim, é feito um projeto de ciência de dados para
catalogação dos animes de acordo os dados obtidos e informados.
