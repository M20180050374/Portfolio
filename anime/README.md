...
## WEB SCRAPING
  ...
  Portanto, nossa primeira etapa consiste em coletar os dados da internet. Para isso, podemos previamente definir os dados que vamos buscar e procurar algum site que atenda a demanda, ou verificar nos sites o que mais conter dados e assim optar por ele. Os dados a serem consultados foram:
